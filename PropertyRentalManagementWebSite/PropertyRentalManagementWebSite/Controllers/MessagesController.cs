...
namespace PropertyRentalManagementWebSite.Controllers
{
    public class MessagesController : Controller
    {
        ...
        {
            var messages = db.Messages.Include(m => m.Tenant);
        ...
        public ActionResult Create([Bind(Include = "MessageId,Content,CreatedDate,TenantId")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MessageId,Content,CreatedDate,TenantId")] Message message)
        {
            if (ModelState.IsValid)
            {
