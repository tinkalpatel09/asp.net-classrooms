...
namespace PropertyRentalManagementWebSite.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        {
            var appointments = db.Appointments.Include(a => a.Tenant);
        ...
        public ActionResult Create([Bind(Include = "AppointmentId,Schedule,Location,AttendingPerson,TenantId")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AppointmentId,Schedule,Location,AttendingPerson,TenantId")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
